...
<head>
    ...
    .info {
        background: linear-gradient(180deg, #fff 0, #f8fbff);
        padding: 2rem;
        flex: 1;
        display: flex;
        flex-direction: column
                    ...
                    <form method="post" action="<?= htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select id="service" name="service" class="form-control" required>
                                ...
                                <option value="mobile" <?= $service === 'mobile' ? 'selected' : '' ?>>Phát triển di động
                                </option>
                                <option value="salesforce" <?= $service === 'salesforce' ? 'selected' : '' ?>>Phát triển
                                    Salesforce</option>
                                <option value="offshore" <?= $service === 'offshore' ? 'selected' : '' ?>>Phát triển
                                    Offshore</option>
                                <option value="testing" <?= $service === 'testing' ? 'selected' : '' ?>>QC & Kiểm thử
                                </option>
                                <option value="consulting" <?= $service === 'consulting' ? 'selected' : '' ?>>Tư vấn
                                    CNTT</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input id="name" name="name" class="form-control" placeholder="Nhập tên của bạn"
                                    required value="<?= htmlspecialchars($name, ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                            <div class="form-group">
                                <label for="phone">Số điện thoại <span class="required">*</span></label>
                                <input id="phone" name="phone" class="form-control" placeholder="Nhập số điện thoại"
                                    required value="<?= htmlspecialchars($phone, ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="company" name="company" class="form-control" placeholder="Tên công ty của bạn"
                                required value="<?= htmlspecialchars($company, ENT_QUOTES, 'UTF-8') ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-lg btn-gradient">
                                ...
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" style="margin-left:0.5rem;vertical-align:middle">
                ...
                <div class="info w-100">
                    ...
                    <div class="meta-item">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M12 2a7 7 0 017 7c0 5-7 13-7 13S5 14 5 9a7 7 0 017-7z" stroke="#2b6cb0"
                    ...
                    <div class="meta-item">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path
                                d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.63A2 2 0 014.11 2h3a2 2 0 012 1.72c.12.99.36 1.95.71 2.85a2 2 0 01-.45 2.11L9.7 9.7a16 16 0 006 6l1.01-1.01a2 2 0 012.11-.45c.9.35 1.86.59 2.85.71A2 2 0 0122 16.92z"
                                stroke="#2b6cb0" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <div>
                    ...
                    <div class="meta-item">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8" stroke="#2b6cb0" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <rect x="2" y="4" width="20" height="16" rx="2" stroke="#2b6cb0" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <div>
                    ...
                    <div class="map">
                        <iframe src="https://www.google.com/maps?q=Hanoi+Vietnam&output=embed" width="100%"
